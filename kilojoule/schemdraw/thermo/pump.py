...
class Pump(Element):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.segments.append(SegmentArc(center=[radius,0], width=2*radius, height=2*radius, theta1=90, theta2=0))
        self.segments.append(Segment([(2*radius,0), (3*radius,0), (3*radius,radius), (radius,radius) ]))
